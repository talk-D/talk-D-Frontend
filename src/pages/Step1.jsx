...
function Step1Page() {
  ...
  <div className="div">
    ...
    <div className="overlap-group">
      ...
      <div className="themename-kor">테마 이름(한글)</div>
      <div className="themename-engframe" />
      <div className="themename-eng">테마 이름(영문)</div>
      <div className="theme-i-dframe" />
      <div className="theme-ID">테마ID</div>
      <div className="themeversionframe" />
      <div className="themeversion">테마 버전</div>
    </div>
    ...
    <div className="thumbnail-wrapper">
      <div className="text-wrapper-2">썸네일</div>
    </div>
    ...
    <div className="chattingroom-wrapper">
      <div className="text-wrapper-2">채팅방</div>
    </div>
